...
class ChatInterface:
    ...
    def __init__(self, use_prefiltering=False):
        """Initialize the chat interface with RAG system."""
        self.rag = ChatRAG(use_prefiltering=use_prefiltering,chat_model_args={'model_name' : 'qwen3:8b'},embedding_model_args={'model_name' : 'Qwen3-Embedding-4B-Q4KM:latest'}
...
def run_interactive_chat(use_prefiltering=False):
...
if __name__ == "__main__":
    ...
    print("Ask questions about your WhatsApp conversations!")
    print("=" * 50)
    
    # Start interactive chat immediately
    run_interactive_chat(use_prefiltering=False)